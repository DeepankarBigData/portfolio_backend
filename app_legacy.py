...
# def generate_from_groq(prompt: str, max_tokens: int = 512) -> str:
#     """
...
#     prompt = (
#         "SYSTEM: You are Deepankar's portfolio assistant. Use only provided chunks. "
...
#     t0 = time.time()
#     try:
#         answer = generate_from_groq(prompt)
#         t_llm = time.time() - t0
